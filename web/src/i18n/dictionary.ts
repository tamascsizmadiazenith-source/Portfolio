...
const dictionary = {
  en: {
    ...
    gallery: {
      ...
      categoriesEyebrow: "Browse the full gallery",
      categoriesHeading: "Every collection, one click away.",
  ...
  hu: {
    ...
    gallery: {
      ...
      categoriesEyebrow: "Böngészd a teljes galériát",
      categoriesHeading: "Minden gyűjtemény egy kattintásra.",
